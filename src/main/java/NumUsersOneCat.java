...
/**
* This is the content panel for the query of if one category was visited at least
* a explicated number of times.
*
* @author Marc Gatti
* @version 1.0
* @since 9/7/2015
*/
public class NumUsersOneCat {
	...
	*/
	...
	private JTextField numUsersTxt;
	...
	*/
	public NumUsersOneCat(ContextSwitcher cs) {
		parentCS = cs;
	}
	...
	*/
	...
	/**
	* Creates the query panel and returns it to the content panel
	* to be added.
	*
	...
	*/
	public JPanel createQueryPane() {
		...
		numUsersTxt = new JTextField("0");
		numUsersTxt.setPreferredSize(new Dimension(55, 24));
        ...
        queryPane.add(new JLabel("Are there more than "));
        queryPane.add(Box.createRigidArea(new Dimension(10,0)));
		queryPane.add(numUsersTxt);
		queryPane.add(Box.createRigidArea(new Dimension(10,0)));
        queryPane.add(new JLabel(" users who looked at "));
        queryPane.add(Box.createRigidArea(new Dimension(10,0)));
		...
		queryBtn.addActionListener(
			new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					int numUsers = Integer.parseInt(numUsersTxt.getText());
					parentCS.requestQuery(0, numUsers, catCb1.getSelectedIndex());
				}
			});
